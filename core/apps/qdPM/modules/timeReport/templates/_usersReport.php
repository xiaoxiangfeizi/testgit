<div class="pageHeading">
  <table>
    <tr>
      ...
      <td style="padding-left: 15px;"><?php echo __('Export') .': <a href="#" onClick="time_report_export(\'users_export\',\'csv\');">.csv</a> | <a href="#" onClick="time_report_export(\'users_export\', \'txt\');">.txt</a>' ?></td>          
    </tr>  
  </table>
</div>
...
<?php
  ...
  $count_items = 0;
?>
  <table class="tableListing" id="tableListingUsers">
    <thead>
      <tr>    
...
<script type="text/javascript">
  $(document).ready(function(){  
    $("#tableListingUsers").tablesorter({widgets: ['zebra']})   
  });     
</script>   
