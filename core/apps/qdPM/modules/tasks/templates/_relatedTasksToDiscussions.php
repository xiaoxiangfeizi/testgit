...
<?php if(Users::hasAccess('insert','tasks',$sf_user,$sf_request->getParameter('projects_id')) and !$is_email): ?>
  <div style="margin-bottom: 10px; margin-top: 5px; text-align: right;"><?php echo link_to_modalbox('+ ' . __('Add'),'tasks/new?related_discussions_id=' . $sf_request->getParameter('discussions_id') . '&projects_id=' . $sf_request->getParameter('projects_id')) ?></div>
<?php endif ?>
