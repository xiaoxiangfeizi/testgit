...
<form id="moveToForm" action="<?php echo url_for('tickets/moveTo') ?>" method="post">
...
<table>
  <tr>
    ...
    <td><?php echo select_tag('move_to','',array('choices'=>Projects::getChoices('tickets',$sf_user)),array('class'=>'required')) ?></td>
  </tr>
  <tr>
    <td></td>
