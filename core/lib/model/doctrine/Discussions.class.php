  ...
  public static function  getListingOrderByType($q,$type)
  {
   switch($type)
   {
     ...
     case 'priority':             $q->orderBy('LTRIM(p.name), dp.sort_order,LTRIM(dp.name),  LTRIM(d.name)');
       break;
     case 'status':               $q->orderBy('LTRIM(p.name), ds.status_group desc, ds.sort_order,LTRIM(ds.name),  LTRIM(d.name)');
       break;
     ...
     case 'group':                $q->orderBy('LTRIM(p.name), dg.sort_order,LTRIM(dg.name),  LTRIM(d.name)');
       break;
     default:                     $q->orderBy('LTRIM(p.name), ds.status_group desc, ds.sort_order,LTRIM(ds.name),  LTRIM(d.name)');
      break;            
   }
